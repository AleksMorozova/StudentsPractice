...
//        {
//            Console.WriteLine("+-------------------------------+");
//            Console.WriteLine($"|{"Sinipalova",15} {"Diana",10} {"Dmitrievna",15}|");
//            Console.WriteLine("+-------------------------------+");
//            Console.ReadKey();
//        }
//    }
...
//            {
//                Console.WriteLine("Please, need correct phrase");
//            }
//            else
//            {
...
//            var num_mounth = Convert.ToInt16(Console.ReadLine());
//            if (mounthNum < 1 || mounthNum > 12)
//            {
//                Console.WriteLine("The mounth is not correct");

//            }
//            else if (num_mounth== 1 || num_mounth== 12 || num_mounth == 2)
//            {
...
//        static void Main(string[] args)
//        {
//            Console.WriteLine("Введите количество километров поездки: ");
...
//            {
//                wager -= wager;
//                Console.WriteLine($"А вы счастливчик {wager}!");
//            }
//            if (res >= 9 && res <= 11)
//            {
//                wager += wager;
//                Console.WriteLine($"Превосходно {wager}!");
//            }
//            if (res == 12)
//            {
//                wager = 10 * wager;
//                Console.WriteLine($"Вы великолепны {wager}!");
//            }
//            Console.ReadKey();
//        }
//    }
...
//            for (; ; )
//            {
//                Console.WriteLine("Программа загадала число  от 0 до 147, пожалуйста, введите число:");
//                n = Console.ReadLine();
...
//                if (Convert.ToInt32(n) == temp)
//                {
//                    Console.WriteLine("Невероятно, но факт, вы угадали!");
//                    return;
//                }
//            }
//        }
...
//            int mid;
//            mid = (a + b + c + d + e) / 5;
//            Console.WriteLine("Средне Арфиметическое пяти чисел:");
//            Console.Write(mid);
//            Console.ReadKey();
...
//            Console.OutputEncoding = Encoding.GetEncoding(1251);
//            int sk;
//            int sl = sk = 64;// количество лапок всех зверушек 
